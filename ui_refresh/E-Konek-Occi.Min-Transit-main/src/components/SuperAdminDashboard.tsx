      ...
      <div className="pt-[28px] flex-1 flex flex-col">
        ...
        {currentRole === 'superadmin' && (
          <div className="flex-1 flex flex-col">
            ...
            <nav className="dashboard-nav fixed bottom-0 left-0 right-0 border-t border-slate-200/70 h-[76px] z-50 flex justify-around items-center px-4 shadow-lg sm:mx-6 sm:mb-6 sm:rounded-[28px]">
              <button
