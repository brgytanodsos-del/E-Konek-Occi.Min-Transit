      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-3rem)] max-w-7xl flex-col gap-6 lg:flex-row lg:items-stretch">
        <div className="flex flex-1 flex-col gap-6 lg:max-w-[46rem]">
          ...
          <PanelHero
            ...
            aside={
              <SurfaceCard className="border-white/10 bg-white/10 p-5 text-white shadow-none backdrop-blur-md">
                <div className="space-y-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-white/60">System overview</p>
                    <h3 className="mt-2 text-xl font-bold">Unified sea and land transit workspace</h3>
                  </div>
