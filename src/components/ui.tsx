...
type Tone = 'navy' | 'emerald' | 'success' | 'amber' | 'danger' | 'neutral';
...
const toneClasses: Record<Tone, string> = {
  ...
  success: 'bg-[rgba(15,139,102,0.12)] text-[#0f8b66] border border-[rgba(15,139,102,0.18)]',
...
export const SurfaceCard = ({ className, children, ...props }: { className?: string; children: React.ReactNode } & React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('surface-card p-6', className)} {...props}>{children}</div>
);
