...
export const StaffAccountRegistration: React.FC<StaffAccountRegistrationProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code?.startsWith('auth/') || errMsg.includes('auth/')) {
         if (err.code === 'auth/email-already-in-use') {
           ...
           errMsg = 'Invalid security credentials supplied. Please check your setup.';
         } else {
           errMsg = 'Failed to submit application. Please check your details.';
         }
      }
      toast.error(errMsg);
    } finally {
