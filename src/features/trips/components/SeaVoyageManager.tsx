...
import { Plus, Edit2, Trash2, Ship as VesselIcon, Calendar, Compass, Users, DollarSign } from 'lucide-react';
...
interface Props {
  ...
  openShipModal: (ship?: Ship) => void;
}

export const SeaVoyageManager: React.FC<Props> = ({ canEditPrices, isSuperAdmin, openShipModal }) => {
  const { ships, setShips, isOnline, formatPST } = useApp();
